<html lang="ru"><head>
    ...
    <!-- CSRF Token -->
    <meta name="csrf-token" content="MNvKXo4GSvNtWzyhWqIi1Lt4ejMkXkWDe4FHIE2I">
...
<body>
    ...
    <form class="w-50" method="POST" action="{{ route('label.create') }}"><input type="hidden" name="_token" value="MNvKXo4GSvNtWzyhWqIi1Lt4ejMkXkWDe4FHIE2I">
    @csrf
    @if ($errors->any())
