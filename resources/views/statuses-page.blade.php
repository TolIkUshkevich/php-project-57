    ...
    <div>
        ...
        <tbody>
            <tr class="border-b border-dashed text-left">
                <td style="color:#2861C3">1</td>
                <td style="color:#2861C3">новая</td>
                <td style="color:#2861C3">02.02.2025</td>
                <td>
                    <a data-confirm="Вы уверены?" data-method="delete" class="text-red-600 hover:text-red-900" href="/task_statuses/4">
                        Удалить
                    </a>
                    <a class="text-blue-600 hover:text-blue-900" href="/task_statuses/4/edit">
                        Изменить
                    </a>
                </td>
            </tr>
